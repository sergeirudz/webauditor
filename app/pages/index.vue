		...
		<div class="flex flex-col items-center pt-8 py-8 mb-24 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
			...
			<form class="w-full max-w-md mx-auto">
				...
				<div class="relative">
					...
					<input type="text" id="website" class="block w-full py-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-blue-500 focus:border-blue-500" placeholder="Sisesta veebilehe aadress..." autocomplete="false" required>
